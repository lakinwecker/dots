...
jabba install openjdk@1.14.0-32
...
curl -Lo cs https://git.io/coursier-cli-linux && chmod +x cs && mv cs ~/bin/ && ./cs --help
cs bootstrap  --java-opt -Xss4m --java-opt -Xms100m --java-opt -Dmetals.client=vim-lsc org.scalameta:metals_2.12:0.8.1 -r bintray:scalacenter/releases -r sonatype:snapshots -o /home/lakin/bin/metals-vim -f
